...
<form class="form-horizontal" action="/admin/brand/store" onSubmit="return but();" method="post" enctype="multipart/form-data" role="form" style="width:97%;">
@csrf
	...
	<div class="form-group" style="width:97%;">
		...
		<div class="col-sm-10">
			<textarea type="text" class="form-control" id="brand_desc" name="brand_desc"placeholder="请输入品牌简介"></textarea>
		</div>
	</div>
